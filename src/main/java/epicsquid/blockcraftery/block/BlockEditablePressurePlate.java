...
import epicsquid.blockcraftery.model.BakedModelEditablePressurePlate;
import epicsquid.blockcraftery.model.BakedModelEditableTrapDoor;
import epicsquid.blockcraftery.tile.TileEditableBlock;
import epicsquid.mysticallib.block.BlockTEPressurePlateBase;
...
public class BlockEditablePressurePlate extends BlockTEPressurePlateBase implements IEditableBlock {
  ...
  public int getMetaFromState(@Nonnull IBlockState state) {
    return (state.getValue(LIGHT) ? 1 : 0) | (state.getValue(POWERED) ? 2 : 0);
  }
